        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-[9px] font-bold text-sky-50 leading-relaxed">If the button is there but fails, go to Settings &rarr; Revoke GitHub, refresh the page, and try clicking Save again.</p>
            </div>
          </div>
        </div>
      </section>
